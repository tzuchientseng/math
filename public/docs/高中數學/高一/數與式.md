...
> $$\text{ Q1: 若 } a + b = 6, \quad ab = 3, \quad a > b, \quad \text{ 求 } a - b = ? $$ $$ \text{ Q2: 設 } x^2 - 4x + 1 = 0, \quad \text{ 兩根為 } \alpha, \beta, \text{ 求 } \[ \alpha^2, \beta^2 \] \text{ 及 } \[ \alpha^3, \beta^3 \] ? $$ $$ \text{ Q3: } t + \frac 1 t = 4, \text{ 求 } \[ t^2 + \frac{1}{t^2} = ? \] \text{ 及 } \[ t^3 + \frac{1}{t^3} = ? \] $$ ![Imgur](https://i.imgur.com/54ZyOic.jpg)
